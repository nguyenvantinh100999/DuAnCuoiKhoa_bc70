    ...
    <section className="About">
      ...
      <div className="AboutItem">
        <div className="row">
          ...
          <div className="col-md-6 bgAboutGreen">
            <img src="/img/hero-flex.553afb64.png" alt="..." />
          </div>
        </div>
      </div>
      <div className="AboutItem ">
        <div className="row reAboutItem">
          <div className="col-md-6 bgAboutBlue ">
            <img src="/img/education-hero.62147e5c.png" alt="..." />
          </div>
          <div className="col-md-6">
      ...
      <div className="AboutItem">
        <div className="row">
          ...
          <div className="col-md-6 bgAboutGreen">
            <img src="/img/olstudy.96378086.png" alt="..." />
          </div>
        </div>
      </div>
      <div className="AboutItem">
        <div className="row reAboutItem">
          <div className="col-md-6 bgAboutBlue">
            <img src="/img/students.fc2d9ab7.png" alt="..." />
          </div>
          <div className="col-md-6">
